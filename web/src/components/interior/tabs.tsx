/**
 * Vendored from interior.dev — https://www.interior.dev/docs/tabs
...
export function Tabs({
  ...
  return (
    <div
      className={`w-full overflow-hidden rounded-[12px] border border-coal/15 bg-cream ${className}`}
    >
      <div
        {...tabs.tabListProps}
        ref={rowRef}
        aria-label={label}
        className="relative flex w-full gap-1 px-1 pt-1"
      >
        <motion.span
          layout
          aria-hidden
          ...
          className="absolute bottom-1 top-1 bg-coal"
      ...
      {renderPanel ? (
        <motion.div
          ...
          className={`text-[13.5px] leading-relaxed text-coal/80 outline-none ${panelClassName}`}
        >

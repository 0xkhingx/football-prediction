/**
 * Vendored from interior.dev — https://www.interior.dev/docs/copy-button
...
const DRAW = { duration: 0.26, ease: [0.23, 1, 0.32, 1] as const } as const;
...
export function CopyButton({
  ...
  return (
    <motion.button
      ...
      className={`pressable inline-flex h-9 select-none items-center gap-2 rounded-full border-2 border-coal/15 px-4 font-mono text-[10px] tracking-[0.25em] text-coal outline-none transition-[border-color,box-shadow,background-color] duration-150 hover:border-coal focus-visible:border-ember disabled:opacity-50 ${className}`}
    >
